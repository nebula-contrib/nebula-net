...
namespace Nebula.Meta
{
  ...
  public partial class GetStatsReq : TBase
  {
    ...
    {
      var tmp885 = new GetStatsReq();
      if(__isset.space_id)
      {
        tmp885.Space_id = this.Space_id;
      }
      tmp885.__isset.space_id = this.__isset.space_id;
      return tmp885;
    }
    ...
    {
      if (!(that is GetStatsReq other)) return false;
    ...
    {
      var tmp888 = new StringBuilder("GetStatsReq(");
      int tmp889 = 0;
      if(__isset.space_id)
      {
        if(0 < tmp889++) { tmp888.Append(", "); }
        tmp888.Append("Space_id: ");
        Space_id.ToString(tmp888);
      }
      tmp888.Append(')');
