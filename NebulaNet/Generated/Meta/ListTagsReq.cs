...
namespace Nebula.Meta
{
  ...
  public partial class ListTagsReq : TBase
  {
    ...
    public ListTagsReq DeepCopy()
    {
      var tmp242 = new ListTagsReq();
      if(__isset.space_id)
      {
        tmp242.Space_id = this.Space_id;
      }
      tmp242.__isset.space_id = this.__isset.space_id;
      return tmp242;
    }
    ...
    {
      if (!(that is ListTagsReq other)) return false;
    ...
    {
      var tmp245 = new StringBuilder("ListTagsReq(");
      int tmp246 = 0;
      if(__isset.space_id)
      {
        if(0 < tmp246++) { tmp245.Append(", "); }
        tmp245.Append("Space_id: ");
        Space_id.ToString(tmp245);
      }
      tmp245.Append(')');
