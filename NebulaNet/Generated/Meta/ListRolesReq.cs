...
namespace Nebula.Meta
{
  ...
  public partial class ListRolesReq : TBase
  {
    ...
    public ListRolesReq DeepCopy()
    {
      var tmp588 = new ListRolesReq();
      if(__isset.space_id)
      {
        tmp588.Space_id = this.Space_id;
      }
      tmp588.__isset.space_id = this.__isset.space_id;
      return tmp588;
    }
    ...
    {
      if (!(that is ListRolesReq other)) return false;
    ...
    {
      var tmp591 = new StringBuilder("ListRolesReq(");
      int tmp592 = 0;
      if(__isset.space_id)
      {
        if(0 < tmp592++) { tmp591.Append(", "); }
        tmp591.Append("Space_id: ");
        Space_id.ToString(tmp591);
      }
      tmp591.Append(')');
