...
namespace Nebula.Meta
{
  ...
  public partial class CreateEdgeReq : TBase
  {
    ...
    {
      var tmp266 = new CreateEdgeReq();
      if(__isset.space_id)
      {
        tmp266.Space_id = this.Space_id;
      }
      tmp266.__isset.space_id = this.__isset.space_id;
      if((Edge_name != null) && __isset.edge_name)
      {
        tmp266.Edge_name = this.Edge_name.ToArray();
      }
      tmp266.__isset.edge_name = this.__isset.edge_name;
      if((Schema != null) && __isset.schema)
      {
        tmp266.Schema = (global::Nebula.Meta.Schema)this.Schema.DeepCopy();
      }
      tmp266.__isset.schema = this.__isset.schema;
      if(__isset.if_not_exists)
      {
        tmp266.If_not_exists = this.If_not_exists;
      }
      tmp266.__isset.if_not_exists = this.__isset.if_not_exists;
      return tmp266;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp267 = new TStruct("CreateEdgeReq");
    ...
    {
      if (!(that is CreateEdgeReq other)) return false;
    ...
    {
      var tmp269 = new StringBuilder("CreateEdgeReq(");
      int tmp270 = 0;
      if(__isset.space_id)
      {
        if(0 < tmp270++) { tmp269.Append(", "); }
        tmp269.Append("Space_id: ");
        Space_id.ToString(tmp269);
      }
      if((Edge_name != null) && __isset.edge_name)
      {
        if(0 < tmp270++) { tmp269.Append(", "); }
        tmp269.Append("Edge_name: ");
        Edge_name.ToString(tmp269);
      }
      if((Schema != null) && __isset.schema)
      {
        if(0 < tmp270++) { tmp269.Append(", "); }
        tmp269.Append("Schema: ");
        Schema.ToString(tmp269);
      }
      if(__isset.if_not_exists)
      {
        if(0 < tmp270++) { tmp269.Append(", "); }
        tmp269.Append("If_not_exists: ");
        If_not_exists.ToString(tmp269);
      }
      tmp269.Append(')');
