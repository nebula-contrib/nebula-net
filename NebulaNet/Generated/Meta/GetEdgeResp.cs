...
namespace Nebula.Meta
{
  ...
  public partial class GetEdgeResp : TBase
  {
    ...
    public GetEdgeResp DeepCopy()
    {
      var tmp285 = new GetEdgeResp();
      if(__isset.code)
      {
        tmp285.Code = this.Code;
      }
      tmp285.__isset.code = this.__isset.code;
      if((Leader != null) && __isset.leader)
      {
        tmp285.Leader = (global::Nebula.Common.HostAddr)this.Leader.DeepCopy();
      }
      tmp285.__isset.leader = this.__isset.leader;
      if((Schema != null) && __isset.schema)
      {
        tmp285.Schema = (global::Nebula.Meta.Schema)this.Schema.DeepCopy();
      }
      tmp285.__isset.schema = this.__isset.schema;
      return tmp285;
    }
    ...
    {
      if (!(that is GetEdgeResp other)) return false;
    ...
    {
      var tmp288 = new StringBuilder("GetEdgeResp(");
      int tmp289 = 0;
      if(__isset.code)
      {
        if(0 < tmp289++) { tmp288.Append(", "); }
        tmp288.Append("Code: ");
        Code.ToString(tmp288);
      }
      if((Leader != null) && __isset.leader)
      {
        if(0 < tmp289++) { tmp288.Append(", "); }
        tmp288.Append("Leader: ");
        Leader.ToString(tmp288);
      }
      if((Schema != null) && __isset.schema)
      {
        if(0 < tmp289++) { tmp288.Append(", "); }
        tmp288.Append("Schema: ");
        Schema.ToString(tmp288);
      }
      tmp288.Append(')');
