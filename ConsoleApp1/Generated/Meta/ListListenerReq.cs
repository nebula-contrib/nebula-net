...
namespace Nebula.Meta
{
  ...
  public partial class ListListenerReq : TBase
  {
    ...
    {
      var tmp866 = new ListListenerReq();
      if(__isset.space_id)
      {
        tmp866.Space_id = this.Space_id;
      }
      tmp866.__isset.space_id = this.__isset.space_id;
      return tmp866;
    }
    ...
    {
      if (!(that is ListListenerReq other)) return false;
    ...
    {
      var tmp869 = new StringBuilder("ListListenerReq(");
      int tmp870 = 0;
      if(__isset.space_id)
      {
        if(0 < tmp870++) { tmp869.Append(", "); }
        tmp869.Append("Space_id: ");
        Space_id.ToString(tmp869);
      }
      tmp869.Append(')');
