...
namespace Nebula.Meta
{
  ...
  public partial class GetTagResp : TBase
  {
    ...
    public GetTagResp DeepCopy()
    {
      var tmp261 = new GetTagResp();
      if(__isset.code)
      {
        tmp261.Code = this.Code;
      }
      tmp261.__isset.code = this.__isset.code;
      if((Leader != null) && __isset.leader)
      {
        tmp261.Leader = (global::Nebula.Common.HostAddr)this.Leader.DeepCopy();
      }
      tmp261.__isset.leader = this.__isset.leader;
      if((Schema != null) && __isset.schema)
      {
        tmp261.Schema = (global::Nebula.Meta.Schema)this.Schema.DeepCopy();
      }
      tmp261.__isset.schema = this.__isset.schema;
      return tmp261;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp262 = new TStruct("GetTagResp");
    ...
    {
      if (!(that is GetTagResp other)) return false;
    ...
    {
      var tmp264 = new StringBuilder("GetTagResp(");
      int tmp265 = 0;
      if(__isset.code)
      {
        if(0 < tmp265++) { tmp264.Append(", "); }
        tmp264.Append("Code: ");
        Code.ToString(tmp264);
      }
      if((Leader != null) && __isset.leader)
      {
        if(0 < tmp265++) { tmp264.Append(", "); }
        tmp264.Append("Leader: ");
        Leader.ToString(tmp264);
      }
      if((Schema != null) && __isset.schema)
      {
        if(0 < tmp265++) { tmp264.Append(", "); }
        tmp264.Append("Schema: ");
        Schema.ToString(tmp264);
      }
      tmp264.Append(')');
